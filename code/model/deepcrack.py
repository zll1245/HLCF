...
from CAT import CrossAttention
...
class DeepCrack(nn.Module):
    ...
    def forward(self,inputs):
        ...
        #fuse part
        # fuse1=self.cat(fuse1, fuse2)
        # fuse2=self.cat(fuse2,fuse3)
        # fuse3=self.cat(fuse3,fuse4)
        # fuse4=self.cat(fuse4,fuse5)
        # fuse5=self.cat(fuse5,fuse1)
